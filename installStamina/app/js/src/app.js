...
function onLoad() {
	try {
		...
		W.StaminaInstaller = new CStaminaInstaller();
		StaminaInstaller.init();
		AppEnv.init([StaminaInstaller, StaminaInstaller.onEnvData], [StaminaInstaller, StaminaInstaller.onEnvData]);
