window.ru = {
	'Extract_files_please_wait' :'Распаковка архива, пожалуйста ждите',
	'copy_config_complete' :'Конфигурация multihosts завершена',
	'Start_copy' :'Копирование файлов',
	'create_fastxampp_folder' :'Создание каталога fastxampp',
	'Sorry_file_' :'Извините, файл ',
	'_not_found_autorun_is_disable' :' не найден, автозапуск xampp не доступен',
